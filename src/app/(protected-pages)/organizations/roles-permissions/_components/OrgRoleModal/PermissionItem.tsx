...
// Extend PermissionDef to include enabled state for the UI
export interface PermissionUI extends PermissionDef {
    enabled: boolean
}
                ...
                <div className="flex items-center gap-2.5 mb-1.5">
                    ...
                    {permission.isSensitive && (
                        <div className="flex items-center gap-1 px-2 py-0.5 bg-rose-50 dark:bg-rose-950/30 rounded-md border border-rose-100/50 dark:border-rose-900/30">
                            <span className="text-[10px] font-black text-rose-500">Sensitive</span>
                        </div>
                    )}
                </div>
