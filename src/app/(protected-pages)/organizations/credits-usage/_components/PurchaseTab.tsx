        ...
        <div className="space-y-12 animate-in fade-in duration-700">
            <div className="text-center max-w-2xl mx-auto space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 rounded-full border border-primary/10">
                    ...
                    <span className="text-xs font-black text-primary">Pricing Plans</span>
                </div>
                    ...
                    return (
                        <Card
                            ...
                            className={classNames(
                                ...
                                isSelected
                                    ? "shadow-2xl shadow-primary/20 bg-white dark:bg-gray-900 scale-105 z-10 ring-2 ring-primary"
                                    : plan.popular
                                        ? "shadow-2xl shadow-primary/20 bg-white dark:bg-gray-900 scale-105 z-10 ring-2 ring-primary/10"
                        ...
                        >
                            {plan.popular && (
                                <div className="absolute top-6 left-1/2 -translate-x-1/2 z-20">
                                    <div className="bg-primary text-white rounded-full px-4 py-1.5 text-xs font-black flex items-center gap-2 shadow-xl shadow-primary/30 whitespace-nowrap">
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className={classNames("space-y-4", plan.popular ? "pt-10" : "pt-2")}>
                                    ...
                                    <div className="space-y-1">
                                        <h4 className="text-lg font-black text-gray-900 dark:text-white tracking-tight">{plan.name}</h4>
                                    ...
                                    <div className="space-y-0">
                                        ...
                                        <div className="flex flex-wrap items-center gap-2 mt-2">
                                            <div className="px-2 py-0.5 bg-gray-100 dark:bg-gray-800 rounded font-black text-[10px] text-gray-700 dark:text-gray-300">
                                                {plan.credits.toLocaleString()} Credits
                                            </div>
                                            {plan.bonus && (
                                                <div className="px-2 py-0.5 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 rounded font-black text-[10px] border border-emerald-100 dark:border-emerald-800/50">
                                                    +{plan.bonus}% Bonus
                                                </div>
                                            )}
                                        </div>
                                ...
                                <div className="space-y-3">
                                    <p className="text-xs font-black text-gray-900 dark:text-gray-100">Service Level</p>
                                ...
                                <button
                                    ...
                                    className={classNames(
                                        "w-full h-11 rounded-xl flex items-center justify-center gap-2 font-black uppercase tracking-[0.2em] text-[9px] transition-all duration-300 group/btn",
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-6 pb-2 sm:pt-8 sm:pb-4 border-t border-gray-100 dark:border-gray-800">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xs font-black text-gray-900 dark:text-gray-100 leading-none">Safe & Secure</span>
                        <span className="text-xs font-bold text-gray-600 dark:text-gray-300 tracking-tight">Encrypted Payments</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xs font-black text-gray-900 dark:text-gray-100 leading-none">Instant Boost</span>
                        <span className="text-xs font-bold text-gray-600 dark:text-gray-300 tracking-tight">Credits added immediately</span>
                    </div>
                </div>
            </div>
        </div>
