...
import { Button, Dialog, Input, Select, Upload, Checkbox, Switcher, DatePicker, TimeInput } from '@/components/ui'
...
const CreateAnnouncementModal = ({ isOpen, onClose, onCreate }: CreateAnnouncementModalProps) => {
            ...
            <div className="p-6 sm:p-10">
                ...
                <div className="mb-10 relative flex items-center justify-between">
                    <div className="flex items-center gap-5">
                        <div className="w-14 h-14 bg-red-50 dark:bg-red-900/10 rounded-2xl flex items-center justify-center border border-red-100 dark:border-red-900/30 shadow-sm">
                            <Megaphone className="w-7 h-7 text-[#8B0000]" />
                        </div>
                        <div>
                            <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight leading-none">Create Announcement</h2>
                            <p className="text-[11px] font-bold text-gray-400 mt-2 capitalize tracking-tight">Post updates to the community dashboard</p>
                        </div>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <div className="space-y-8">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <textarea
                                        ...
                                        placeholder="What would you like to announce to the members?"
                                    />
                                )}
                            />
                        ...
                        {/* Mark as Important & Schedule for later */}
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <DatePicker
                                                ...
                                                inputPrefix={<Calendar className="w-5 h-5 text-[#8B0000]" />}
                                                className="h-14 bg-gray-50/50 dark:bg-gray-800/10 border-gray-100 dark:border-gray-800 rounded-2xl font-bold pt-0 shadow-inner"
                                            />
                                        )}
                                    />
                                </div>
                                <div className="space-y-3">
                                    <label className="text-[13px] font-bold text-gray-900 dark:text-gray-300 capitalize tracking-tight leading-none pl-1">Post Time</label>
                                    <Controller
                                        name="scheduledTime"
                                        control={control}
                                        render={({ field }) => (
                                            <div className="grid grid-cols-3 gap-2 sm:gap-4">
                                                <Select
                                                    ...
                                                    styles={{ 
                                                        ...
                                                        control: (base) => ({ ...base, height: '3.5rem', borderRadius: '1rem' })
                                                    }}
