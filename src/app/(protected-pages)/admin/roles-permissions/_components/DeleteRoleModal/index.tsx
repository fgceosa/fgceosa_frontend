                ...
                <div className="relative p-10 overflow-hidden bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-4">
                        ...
                        <div className="space-y-1">
                            <span className="text-[10px] font-black text-rose-600 uppercase tracking-[0.4em] opacity-80 whitespace-nowrap">Security Alert</span>
                            <h3 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tight">Delete Custom Role</h3>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-10 space-y-8">
                    ...
                    <div className="text-center space-y-4">
                        <p className="text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                            Are you sure you want to delete the <span className="font-black text-gray-900 dark:text-white uppercase tracking-tight">&quot;{role.name}&quot;</span> role?
                        </p>
                    ...
                    <div className="flex items-center gap-4 pt-2">
                        <Button
                            ...
                            onClick={onClose}
                            disabled={isDeleting}
                            className="h-14 flex-1 rounded-2xl font-black uppercase tracking-widest text-[10px] bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 border-none transition-all"
                        >
                            Cancel
                        </Button>
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                            loading={isDeleting}
                            className="h-14 flex-1 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] bg-rose-600 hover:bg-rose-700 text-white shadow-xl shadow-rose-200/50 dark:shadow-none transition-all group overflow-hidden relative"
                        >
