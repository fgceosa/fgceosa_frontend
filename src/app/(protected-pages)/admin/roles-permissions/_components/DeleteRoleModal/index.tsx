                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="space-y-2 mb-8">
                        ...
                        <div className="text-[13px] font-bold text-gray-500 leading-relaxed px-4">
                            Are you sure you want to delete the <span className="font-black text-gray-900 dark:text-white">&quot;{role.name}&quot;</span> role? Users assigned to this role may lose their permissions.
                        </div>
                    </div>
