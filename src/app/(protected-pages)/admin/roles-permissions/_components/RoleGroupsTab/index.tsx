...
const GROUP_CONFIG = {
    System: {
        ...
        description: 'Core platform roles pre-defined for system-wide administration and governance.'
    },
    Organization: {
        icon: Layers,
        color: 'text-blue-600',
        ...
        description: 'Roles specifically designed for organization-level resource management.'
    },
    Custom: {
        icon: Lock,
        ...
        description: 'Bespoke roles created to match specific operational requirements.'
    }
}
                    ...
                    >
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="space-y-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <Badge className={classNames("font-black text-[10px] uppercase tracking-widest border-none px-3 py-1", config.bg, config.color)}>
                            ...
                            <Button variant="plain" className="h-12 px-6 rounded-2xl bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white border-none gap-2 shrink-0">
                                <span className="text-[10px] font-black uppercase tracking-widest">Manage Group</span>
