    ...
    return (
        <button
            className={classNames(
                'group relative cursor-default outline-none transition-all duration-500 hover:-translate-y-1 h-full w-full border-none bg-transparent p-0',
                className
            )}
            onClick={handleClick}
        >
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        {trend && (
                            <span className={classNames(
                                ...
                                trendType === 'success' && "text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10",
                                trendType === 'warning' && "text-amber-500 bg-amber-50 dark:bg-amber-500/10",
                                trendType === 'danger' && "text-rose-500 bg-rose-50 dark:bg-rose-500/10"
                            )}>
                                {trend}
                            </span>
                        )}
