...
import { CreditCard, Plus, Zap, Settings2, ShieldCheck, CheckCircle2 } from 'lucide-react'
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            <div className="text-center max-w-2xl mx-auto space-y-4 mb-12">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 rounded-full border border-primary/10">
                    ...
                    <span className="text-[10px] font-black text-primary">Billing Settings</span>
                </div>
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-black text-gray-900 dark:text-white">Smart Reload</h2>
                                    <p className="text-[10px] font-black text-gray-400 mt-1">Zero-Downtime Protection</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="flex items-start gap-4 p-4 bg-emerald-50/50 dark:bg-emerald-900/10 rounded-2xl border border-emerald-100 dark:border-emerald-800/20">
                            ...
                            <div className="space-y-1">
                                <h2 className="text-3xl font-black text-white">Continuous Service</h2>
                                <p className="text-[10px] font-bold text-emerald-700/70 dark:text-emerald-500/70 leading-relaxed">
                        ...
                        <Button
                            variant="solid"
                            disabled={!autoTopUpEnabled}
                            className="w-full h-14 bg-primary hover:bg-primary-deep text-white font-black text-[10px] rounded-2xl shadow-xl shadow-primary/20"
                            onClick={() => {
                                toast.push(
                ...
                <Card className="p-0 border-none shadow-2xl shadow-gray-200/50 dark:shadow-none bg-white dark:bg-gray-900 rounded-[2.5rem] overflow-hidden">
                    <div className="p-8 space-y-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-black text-gray-900 dark:text-white leading-none">Saved Cards</h3>
                                <p className="text-[10px] font-black text-gray-400 mt-1">Encrypted Payment Methods</p>
                            </div>
                        </div>
                        ...
                        <div className="relative p-8 bg-gradient-to-br from-primary via-primary-deep/90 to-black rounded-[2rem] overflow-hidden shadow-2xl group border border-white/10">
                            ...
                            <div className="flex justify-between items-start mb-16 relative z-10">
                                ...
                                <div className="px-3 py-1 bg-white/10 backdrop-blur-xl text-white text-[8px] font-black rounded-full border border-white/20 shadow-lg">
                                    Primary Source
                                </div>
                            </div>
                            ...
                            <div className="space-y-6 relative z-10">
                                ...
                                <div className="flex justify-between items-end">
                                    <div className="space-y-1">
                                        <p className="text-[8px] text-white/40 font-black leading-none">Expiration</p>
                                    ...
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl shadow-lg">
                                        ...
                                        <span className="text-[9px] text-white font-black drop-shadow-md">Verified</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-2 space-y-4">
                            <button
                                ...
                                className="w-full h-14 bg-gray-50/50 dark:bg-gray-800/50 border border-dashed border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 font-black rounded-2xl text-[10px] hover:bg-white dark:hover:bg-gray-800 hover:border-primary/20 transition-all flex items-center justify-center gap-3"
                            >
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-6 pt-2 opacity-30 select-none grayscale">
                                {['VISA', 'MASTERCARD', 'VERVE'].map(brand => (
                                    <span key={brand} className="text-[10px] font-black text-gray-400">{brand}</span>
                                ))}
                            </div>
                        </div>
                    </div>
