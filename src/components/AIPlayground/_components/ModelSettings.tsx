        ...
        <Card className="p-0 border-none shadow-xl shadow-gray-200/50 dark:shadow-none bg-white dark:bg-gray-900 rounded-[2rem] overflow-hidden border border-gray-100 dark:border-gray-800 h-fit">
            <div className="p-5 sm:p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-800/10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">AI Settings</h3>
                        <p className="text-[10px] text-gray-400 font-bold">Adjust how the AI works</p>
                    </div>
                </div>
            </div>
            ...
            <div className="p-5 sm:p-6 space-y-8">
                ...
                <div className="space-y-3">
                    <label className="text-[10px] font-black text-gray-400 pl-1">Pick an AI Model</label>
                    <Select
                    ...
                    <div className="space-y-4">
                        {selectedModelData.is_free && (
                            <div className="p-4 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800/30 rounded-2xl">
                                <p className="text-[10px] text-emerald-700 dark:text-emerald-400 font-black flex items-center gap-2">
                ...
                <div className="space-y-6 pt-4 border-t border-gray-50 dark:border-gray-800">
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <label className="text-[10px] font-black text-gray-400">Creativity Level</label>
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <label className="text-[10px] font-black text-gray-400">Response Length</label>
                            <span className="text-xs font-black text-primary px-2 py-0.5 bg-primary/5 rounded border border-primary/10">
                                {maxTokens}
                            </span>
                        </div>
                ...
                <div className="p-5 bg-gradient-to-br from-[#0055BA] to-[#003d85] rounded-2xl shadow-xl shadow-primary/20 relative overflow-hidden group">
                    ...
                    <div className="space-y-3 relative z-10">
                        <div className="flex justify-between items-center">
                            <span className="text-[9px] font-black text-white/40">Estimated Max Cost</span>
                            <span className="text-sm font-black text-white tracking-tight">
                                {selectedModelData?.is_free 
                                    ? '₦0.00' 
                                    : `₦${(((maxTokens / 1000000) * (selectedModelData?.pricing?.output || 0)) * 1650).toFixed(2)}`}
                            </span>
                        </div>
                        <div className="h-px bg-white/10" />
                        <div className="flex justify-between items-center pt-1">
                            <span className="text-[9px] font-black text-white/40">Max Response</span>
