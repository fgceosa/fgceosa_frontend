...
const Dialog = (props: DialogProps) => {
    ...
    if (width !== undefined) {
        // Use pure CSS for responsiveness instead of JS sizing which causes layout flashes
        contentStyle.content.width = '100%'
        contentStyle.content.maxWidth = `min(95vw, ${width}px)`
    }
