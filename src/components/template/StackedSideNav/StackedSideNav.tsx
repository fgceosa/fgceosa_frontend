...
const StackedSideNav = () => {
    ...
    return (
        <div className="stacked-side-nav hidden lg:flex sticky top-0 h-screen z-20">
            <StackedSideNavMini
                ...
                userAuthority={(session?.user as User)?.authority || []}
                userPermissions={(session?.user as User)?.permissions || []}
